      ...
      <article className="max-w-3xl mx-auto px-6 pb-12">
        <div className="bg-[#0d0d12] border border-white/8 rounded-2xl overflow-hidden mb-10">
          <div className="aspect-[16/9] relative">
            <Image src="/images/factory/gallery2.jpg" alt="Verify garment care factory in China - XINGYUE manufacturing base tour" fill className="object-cover" unoptimized />
          </div>
        </div>
