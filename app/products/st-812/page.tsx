...
const images = [
  ...
  "/images/products/st812/detail1.jpg",
  "/images/products/st812/detail2.jpg",
  "/images/products/st812/detail3.jpg",
  "/images/products/st812/detail4.jpg",
  "/images/products/st812/detail5.jpg",
  "/images/products/st812/detail6.jpg",
];

const features = [
  { title: "Lightweight Design", desc: "Easy to carry and store for everyday use" },
  { title: "Ceramic Soleplate", desc: "Smooth glide with even heat distribution" },
  { title: "Powerful Steam", desc: "Max 25g/min steam output for efficient wrinkle removal" },
  { title: "Large Water Tank", desc: "160ml capacity for extended ironing sessions" },
];
...
export default function ST812Page() {
    ...
    <div className="bg-[#050507] text-white min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-8 grid gap-10 lg:grid-cols-2 items-start product-hero-grid">
        <div>
          ...
          <h1 className="text-5xl md:text-6xl font-black tracking-tight">ST-812</h1>
          ...
          <div className="mt-6 flex gap-4">
            {[["750g", "Lightweight"], ["1300W", "Heating"], ["160ml", "Tank"]].map(([val, label]) => (
          ...
          <div className="mt-8 flex flex-col sm:flex-row sm:flex-wrap gap-3">
            <Link href="/contact?product=ST-812" className="w-full sm:w-auto justify-center px-5 py-3 bg-[#ff2f7d] text-white font-semibold rounded-full text-sm hover:bg-[#e6006f] transition inline-flex items-center gap-2">
              Request Quote
            </Link>
            <a href="/specs/st-812-spec.pdf" download className="w-full sm:w-auto justify-center px-5 py-3 border border-white/20 text-white font-semibold rounded-full text-sm hover:border-white/50 transition inline-flex items-center gap-2">
        ...
        <div className="bg-[#0d0d12] rounded-2xl overflow-hidden border border-white/8 product-gallery">
          <div className="aspect-square relative" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
            <Image src={images[imgIdx]} alt="ST-812 lightweight travel iron with 160ml water tank, XINGYUE manufacturer" fill sizes="(max-width:1023px) 100vw, 50vw" className="object-contain p-4" />
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold text-center">Experience ST-812</h2>
        ...
        <div className="rounded-2xl overflow-hidden border border-white/8 bg-black max-w-2xl mx-auto">
          <video controls className="w-full aspect-video" poster="/images/products/st812/main.jpg" preload="metadata">
            <source src="/videos/st812.mp4" type="video/mp4" />
          </video>
        </div>
      </section>
