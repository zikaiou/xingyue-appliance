...
const images = [
  "/images/products/st588/main.jpg",
  "/images/products/st588/detail1.jpg",
  "/images/products/st588/detail2.jpg",
  "/images/products/st588/detail3.jpg",
  "/images/products/st588/detail4.jpg",
  "/images/products/st588/detail5.jpg",
  "/images/products/st588/detail6.jpg",
  "/images/products/st588/detail7.jpg",
];

const features = [
  { title: "Dry & Steam Function", desc: "Flexible ironing modes for all fabric types" },
  { title: "Ceramic Soleplate", desc: "Smooth ironing performance with even heat" },
  { title: "Fast Heating", desc: "Quick preparation for efficient garment care" },
...
const specs = [
  ...
  ["Product Size", "257 x 72 x 123 mm"],
  ["Net Weight", "795g"],
  ["Rated Power", "1200W"],
  ["Voltage", "AC 220-240V"],
  ["Water Tank", "140ml"],
...
export default function ST588Page() {
    ...
    <div className="bg-[#050507] text-white min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-8 grid gap-10 lg:grid-cols-2 items-start">
        <div>
          ...
          <h1 className="text-5xl md:text-6xl font-black tracking-tight">ST-588</h1>
          ...
          <div className="mt-6 flex gap-4">
            {[["795g", "Lightweight"], ["1200W", "Heating"], ["140ml", "Tank"]].map(([val, label]) => (
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/contact?product=ST-588" className="px-5 py-3 bg-[#ff2f7d] text-white font-semibold rounded-full text-sm hover:bg-[#e6006f] transition">
              Request Quote
            </Link>
            <a href="/specs/st-588-spec.pdf" download className="px-5 py-3 border border-white/20 text-white font-semibold rounded-full text-sm hover:border-white/50 transition inline-flex items-center gap-2">
        ...
        <div className="bg-[#0d0d12] rounded-2xl overflow-hidden border border-white/8">
          <div className="aspect-square relative" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
            <Image src={images[imgIdx]} alt="ST-588 compact travel iron with dry and steam function, China factory" fill className="object-contain p-4" unoptimized />
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold text-center">Experience ST-588</h2>
        ...
        <div className="rounded-2xl overflow-hidden border border-white/8 bg-black max-w-2xl mx-auto">
          <video controls className="w-full aspect-video" poster="/images/products/st588/main.jpg" preload="metadata">
            <source src="/videos/st588.mp4" type="video/mp4" />
          </video>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <Link href="/contact?product=ST-588" className="mt-8 inline-block px-8 py-3 bg-[#ff2f7d] text-white font-semibold rounded-full text-sm hover:bg-[#e6006f] transition">Request OEM Quote</Link>
      </section>
...
<section className="border-t border-white/8 py-20 text-center px-6">
        <h2 className="text-3xl font-bold">Interested in ST-588?</h2>
        <p className="mt-3 text-white/50 max-w-md mx-auto">Get factory pricing and customization options.</p>
        <Link href="/contact?product=ST-588" className="mt-8 inline-block px-8 py-3 bg-[#ff2f7d] text-white font-semibold rounded-full text-sm hover:bg-[#e6006f] transition">Send Inquiry</Link>
      </section>
    </div>
  );
}
