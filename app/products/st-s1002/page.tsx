...
const images = [
  "/images/products/sts1002/main.jpg",
  "/images/products/sts1002/detail1.jpg",
  "/images/products/sts1002/detail2.jpg",
];

const features = [
  { title: "3000W Powerful Steam", desc: "High-performance heating element for rapid and maximum steam penetration." },
  { title: "Large 420ml Tank", desc: "Extended water capacity for heavy-duty ironing sessions without interruption." },
  { title: "Ceramic Smooth Plate", desc: "Premium ceramic coating for effortless glide on even the most delicate fabrics." },
  { title: "Auto Shut-Off", desc: "Advanced safety sensors that automatically cut power when left unattended." },
];

const specs = [
  ["Model", "ST-S1002"],
  ["Category", "Steam Iron"],
  ["Voltage", "110-127V 60Hz / 220-240V 50-60Hz"],
  ["Rated Power", "1200W / 1800-3000W"],
  ["Water Tank", "420ml"],
  ["Soleplate", "Ceramic / Non-stick"],
  ["Soleplate Size", "251 x 125 mm"],
  ["Product Size", "304 x 129 x 150 mm"],
  ["Gift Box", "325 x 133 x 163 mm"],
  ["Carton", "552 x 335 x 340 mm"],
  ["Qty/Carton", "8 pcs"],
  ["Net/Gross Weight", "10.4 / 11 kg"],
  ["20GP Loading", "3320 pcs"],
  ["40GP Loading", "6920 pcs"],
  ["40HQ Loading", "8000 pcs"],
];

const scenes = ["Professional Use", "Large Families", "Laundry Business", "Garment Factory"];
const oemItems = ["Logo Customization", "Color Options", "Soleplate Customization", "Packaging Design", "Mass Production Support"];

export default function STS1002Page() {
    ...
    <div className="bg-[#050507] text-white min-h-screen font-sans">
      ...
      <section className="max-w-6xl mx-auto px-6 py-8 grid gap-10 lg:grid-cols-2 items-start product-hero-grid">
        <div className="reveal is-visible">
          ...
          <h1 className="text-5xl md:text-6xl font-black tracking-tight">ST-S1002</h1>
          <h2 className="text-xl text-white/70 mt-2">Ultra-Powerful Steam Iron</h2>
          <p className="text-white/50 mt-2 text-sm">Professional Grade 3000W Performance</p>

          <div className="mt-6 flex gap-4">
            {[["3000W", "Heating"], ["420ml", "Tank"], ["Ceramic", "Plate"]].map(([val, label]) => (
          ...
          <div className="mt-8 flex flex-col sm:flex-row sm:flex-wrap gap-3">
            <Link href="/contact?product=ST-S1002" className="w-full sm:w-auto justify-center px-5 py-3 bg-[#ff2f7d] text-white font-semibold rounded-full text-sm hover:bg-[#e6006f] transition inline-flex items-center gap-2">
              Request Quote
            </Link>
            <a href="/specs/st-s1002-spec.pdf" download className="w-full sm:w-auto justify-center px-5 py-3 border border-white/20 text-white font-semibold rounded-full text-sm hover:border-white/50 transition inline-flex items-center gap-2">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold text-center">Experience ST-S1002</h2>
        ...
        <div className="rounded-2xl overflow-hidden border border-white/8 bg-black max-w-2xl mx-auto shadow-2xl shadow-[#ff2f7d]/5">
          <video controls className="w-full aspect-video" poster="/images/products/sts1002/main.jpg" preload="metadata">
            <source src="/videos/sts1002.mp4" type="video/mp4" />
          </video>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <Link href="/contact?product=ST-S1002" className="mt-8 inline-block px-8 py-3 bg-[#ff2f7d] text-white font-semibold rounded-full text-sm hover:bg-[#e6006f] transition">Request OEM Quote</Link>
      </section>

            <RelatedProducts title="Related Products"  />

<section className="border-t border-white/8 py-20 text-center px-6">
        <h2 className="text-3xl font-bold">Interested in ST-S1002?</h2>
        <p className="mt-3 text-white/50 max-w-md mx-auto">Get factory pricing and customization options.</p>
        <Link href="/contact?product=ST-S1002" className="mt-8 inline-block px-8 py-3 bg-[#ff2f7d] text-white font-semibold rounded-full text-sm hover:bg-[#e6006f] transition">Send Inquiry</Link>
      </section>
    </div>
  );
}
