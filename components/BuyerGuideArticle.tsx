  ...
  return (
    <article className="min-h-screen bg-[#050507] text-white font-sans">
      ...
      <div className="mx-auto max-w-3xl px-6 pb-20">
        ...
        <p className="mb-10 text-white/70 leading-8">A sourcing decision is only useful when the supplier, product, compliance and commercial requirements are considered together. Use this guide to structure your next conversation with a garment-care manufacturer and to identify the evidence you should request before placing an order.</p>
