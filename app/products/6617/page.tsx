...
export default function P6617Page() {
  ...
  const relatedItems = [{ model: "ST-815", img: "/images/products/ST-815.png", desc: "1600W handheld steamer with 340ml tank" },{ model: "900A", img: "/images/products/900A.png", desc: "Compact steamer with stainless steel panel" },{ model: "6618", img: "/images/products/6618.jpg", desc: "Foldable steamer with 3 steam modes" }];
      ...
      <section className="max-w-6xl mx-auto px-6 py-8 grid gap-10 lg:grid-cols-2 items-start">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="/specs/6617-spec.pdf" download className="px-5 py-3 border border-white/20 text-white font-semibold rounded-full text-sm hover:border-white/50 transition inline-flex items-center gap-2">
        ...
        <div className="bg-[#0d0d12] rounded-2xl overflow-hidden border border-white/8">
          <div className="aspect-square relative" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
            <Image src={images[imgIdx]} alt="6617 garment steamer with ceramic steam panel 1800W, China manufacturer" fill className="object-contain p-4" unoptimized />
