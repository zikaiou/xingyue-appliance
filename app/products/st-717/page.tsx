...
const images = [
  "/images/products/st717/main.jpg",
  "/images/products/st717/detail1.jpg",
  "/images/products/st717/detail2.jpg",
  "/images/products/st717/detail3.jpg",
  "/images/products/st717/detail4.jpg",
  "/images/products/st717/detail6.jpg",
  "/images/products/st717/detail7.jpg",
];
...
export default function ST717Page() {
  ...
  return (
    <div className="bg-[#050507] text-white min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-8 grid gap-10 lg:grid-cols-2 items-start product-hero-grid">
        ...
        <div className="bg-[#0d0d12] rounded-2xl overflow-hidden border border-white/8 product-gallery">
          <div className="aspect-square relative" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
            <Image src={images[imgIdx]} alt="ST-717 portable travel iron with fast heating, XINGYUE manufacturer" fill sizes="(max-width:1023px) 100vw, 50vw" className="object-contain p-4" />
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold text-center">Experience ST-717</h2>
        ...
        <div className="rounded-2xl overflow-hidden border border-white/8 bg-black max-w-2xl mx-auto">
          <video controls className="w-full aspect-video" poster="/images/products/st717/main.jpg" preload="metadata">
            <source src="/videos/st717.mp4" type="video/mp4" />
          </video>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <Link href="/contact?product=ST-717" className="mt-8 inline-block px-8 py-3 bg-[#ff2f7d] text-white font-semibold rounded-full text-sm hover:bg-[#e6006f] transition">
          Request OEM Quote
        </Link>
      </section>
