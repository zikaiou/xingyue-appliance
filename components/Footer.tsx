  ...
  return (
    <footer className="border-t border-white/10 bg-black">
      <div className="container-shell grid gap-10 py-14 md:grid-cols-3">
        <div>
          <div className="text-2xl font-black tracking-[0.25em]">XING</div>
        ...
        <div>
          ...
          <p className="mt-4 text-white/60">{siteConfig.company}</p>
          <a className="mt-2 block text-white/60" href={`mailto:${siteConfig.email}`}>
            {siteConfig.email}
          </a>
          <a
      ...
      <div className="border-t border-white/10 py-5 text-center text-sm text-white/40">
        © {new Date().getFullYear()} XING. All rights reserved.
      </div>
    </footer>
  );
}
