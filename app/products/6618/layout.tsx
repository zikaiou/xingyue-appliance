...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.xingyue-appliance.com/products/6618" },
};
...
﻿export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Garment Steamers", item: "https://www.xingyue-appliance.com/products/garment-steamers" },
      { "@type": "ListItem", position: 4, name: "6618", item: "https://www.xingyue-appliance.com/products/6618" }
    ],
  };
  const videoSchema = {
    "@context": "https://schema.org",
